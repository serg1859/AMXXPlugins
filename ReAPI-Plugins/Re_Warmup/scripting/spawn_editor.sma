...
new g_iszInfoTarget;
new szConfigDir[MAX_PATH_LEN+32], szMapName[32] 

public plugin_init()
{
	register_plugin(PLUGINNAME, VERSION, AUTHORS);
	register_concmd("warmup_edit_spawns", "Command_EditSpawns", ADMIN_MAP, "Edits spawn configuration");
...
readSpawns()
{
	...
	formatex(MapFile, 255, "%s/warmup_spawns/%s.spawns.cfg", szConfigDir, szMapName);
	g_TotalSpawns = 0;
...
public Command_EditSpawns(id, level)
{
